...
class ApplicationSettingsStorage {
    ...
    private enum Attributes {
        ...
        var identifier: String {
            ...
            case .networkAPIKey: return "General.Network.APIKey"
            case .networkIdentity: return "General.Network.Identity"
            }
        }
    }
    ...
    static var DeveloperSettings: ApplicationSettingsStorage = {
        ...
        settings.networkAPIKey = "f60bbf23"
        settings.networkIdentity = "tt3896198"
        return settings
    }()
    ...
    var networkIdentity: String {
        get {
            return settings[Attributes.networkIdentity.identifier] as? String ?? ApplicationSettingsStorage.DefaultSettings.networkIdentity
        }
        set {
            settings[Attributes.networkIdentity.identifier] = newValue as AnyObject
        }
    }
